...
- Do NOT include internal document filenames (e.g., Pricing.pdf, RefundPolicy.pdf) or item markers (e.g., "Item 1 — Pricing.pdf") in your response text. Present answers seamlessly as customer support.
